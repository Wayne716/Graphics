...
int main()
{
    ...
    std::vector<std::vector<int>> pin {{0, 0}, {19, 0}};
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        int dataSize = (int)cloth->springs.size() * 3 * 2;
        float v[dataSize];
        ...
        glDrawArrays(GL_LINES, 0, (int)cloth->springs.size() * 2);
