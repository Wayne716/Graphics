...
int main()
{
    ...
    Model mod("texture/nanosuit/nanosuit.obj");
    
    shader0.use();
    shader0.setInt("tex1", 0);
    
    shader1.use();
    shader1.setInt("screenTexture", 3);
    
    shader2.use();
    shader2.setInt("skybox", 3);
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        shader0.setVec3("cameraPos", camera.Position);
