...
void renderScene(const Shader& shader) {
    ...
    model = glm::scale(glm::translate(glm::mat4(1.0f), glm::vec3(0.0, 1.5, 0.0)), glm::vec3(0.5f));
    shader.setMat4("model", model);
    renderCube();
    model = glm::scale(glm::translate(glm::mat4(1.0f), glm::vec3(2.0, 0.0, 1.0)), glm::vec3(0.5f));
    shader.setMat4("model", model);
    renderCube();
    model = glm::scale(glm::rotate(glm::translate(glm::mat4(1.0f), glm::vec3(-1.0, 0.0, 2.0)), glm::radians(60.0f), glm::normalize(glm::vec3(1.0, 0.0, 1.0))), glm::vec3(0.25f));
    shader.setMat4("model", model);
    renderCube();
}
...
int main()
{
    ...
    Shader shader0("shadow.vs", "shadow.fs");
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        // lights render depth to texture
        ...
        shader0.use();
        // model in renderScene
        shader0.setMat4("lightSpace", lightSpace);
        ...
        shader2.setMat4("space", lightSpace);
        glActiveTexture(GL_TEXTURE0);
        glBindTexture(GL_TEXTURE_2D, woodTexture);
