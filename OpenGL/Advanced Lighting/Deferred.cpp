...
int main()
{
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        for (unsigned int i=0; i<objectPositions.size(); ++i) {
            model = glm::scale(glm::translate(glm::mat4(1.0f), objectPositions[i]), glm::vec3(0.5f));
        ...
        shader.setVec3("lightsPos", camera.Position);
        renderQuad();
        ...
        for (unsigned int i=0; i<lightPositions.size(); ++i) {
            model = glm::scale(glm::translate(glm::mat4(1.0f), lightPositions[i]), glm::vec3(0.125f));
