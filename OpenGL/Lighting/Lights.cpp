...
int main()
{
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        cube.setFloat("spotLight.inner", glm::cos(glm::radians(12.5f)));
        cube.setFloat("spotLight.outer", glm::cos(glm::radians(15.0f)));
        ...
        for (int i=0; i<4; ++i) {
            ...
            glm::mat4 model = glm::scale(glm::translate(glm::mat4(1.0f), pointLightPositions[i]), glm::vec3(0.1f));
